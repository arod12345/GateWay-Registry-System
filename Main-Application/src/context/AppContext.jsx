...
export const AppProvider = ({ children }) => {
  ...
  const handleFormSubmission = async formData => {
    ...
    try {
      const response = await axios.post("https://gateway-registry-system.onrender.com/api/visitors", formData, {
        headers: {
  ...
  const handleWeaponFormSubmission = async weaponFormData => {
    ...
    try {
      const response = await axios.post("https://gateway-registry-system.onrender.com/api/weapons", weaponFormData, {
        headers: {
          "Content-Type": "application/json"
        }
      });
  ...
  const handleVehicleFromSubmission = async vehiclesFromData => {
    ...
    try {
      const response = await axios.post("https://gateway-registry-system.onrender.com/api/vehicles", vehiclesFromData, {
        headers: {
          "Content-Type": "application/json"
        }
      });
